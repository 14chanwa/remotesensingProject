...
We first write codes to compute and display EPIs. These correspond to \verb#test_build_row_epi.cpp#. We investigate possible artefacts that appear in the EPIs extracted from the rectified images of Skysat, with step $18$.
...
\begin{figure}[ht]
  ...
  \caption{Row 380 -- The high building has a very steep slope.}
\end{figure}
